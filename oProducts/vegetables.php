        ...
        <div class="ltn__product-item ltn__product-item-3 text-center">
            <div class="product-img">
                ...
                <div class="product-hover-action">
                    <ul>
                        <li>
                            <a href="product-details.php?id=<?php echo $Vegetable['product_id'] ?>" title="Quick View">
                                <i class="far fa-eye"></i>
                            </a>
                        </li>
                        <li>
                            <a href="cart.php?id=<?php echo $Vegetable['product_id'] ?>" title="Add to Cart">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        </li>
                        <li>
                            <a href="wishlist.php?id=<?php echo $Vegetable['product_id'] ?>" title="Wishlist">
