...
$sqli = "SELECT * FROM broccoli_catagory ORDER BY catagory_id DESC ";
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="showing-product-number text-right">
                                <span>Showing 1–15 of <?php echo $noOfPages ?> results</span>
                            </div>
                        </li>
                        <!-- <li>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="product-details.php?id=<?php echo $product['product_id']; ?>"><?php echo $product['product_name'] ?></a></h2>
                    ...
                    <div class="widget ltn__menu-widget">
                        ...
                        <ul>
                            <?php foreach ($catagorys as $catagory) : ?>
                                <li><a href="./catagory.php?id=<?php echo $catagory['catagory_id'] ?> "><?php echo $catagory['catagory_name']  ?><span><i class="fas fa-long-arrow-alt-right"></i></span></a></li>
                            <?php endforeach ?>
