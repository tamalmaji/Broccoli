...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($login)) {
        $login_err = 'Enter Your User Name';
    }
    if (empty($cpwd)) {
        $cpwd_err = 'Enter Your Password';
    }
            ...
            if ($statement->execute()) {
                if ($statement->rowCount() === 1) {
                    if ($row = $statement->fetch()) {
                        ...
                        if (password_verify($cpwd, $haspassword)) {
                            session_start();
                            ...
                            $cpwd_err = 'The password you enterd is not valid';
                        }
                    }
                }else{
                    $cpwd_err = 'No account found for that eamail';
                }
            }else{
