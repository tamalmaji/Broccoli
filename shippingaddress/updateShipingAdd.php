...
$fName = $ShippingAdd['shippingAddress_fname'];
$num = $ShippingAdd['shippingAddress_mNum'];
$pin =  $ShippingAdd['shippingAddress_pin'];
$build =  $ShippingAdd['shippingAddress_house'];
$street =  $ShippingAdd['shippingAddress_street'];
$landmark =  $ShippingAdd['shippingAddress_landmark'];
$city =  $ShippingAdd['shippingAddress_city'];
$state =  $ShippingAdd['shippingAddress_state'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($fName_err) && empty($num_err) && empty($pin_err) && empty($build_err) && empty($city_err) && empty($state_err)) {
        $sqll = 'UPDATE broccoli_shippingaddress SET shippingAddress_fname = :shippingAddress_fname, shippingAddress_mNum = :shippingAddress_mNum, shippingAddress_pin = :shippingAddress_pin, shippingAddress_house = :shippingAddress_house, shippingAddress_street = :shippingAddress_street, shippingAddress_landmark = :shippingAddress_landmark, shippingAddress_city = :shippingAddress_city, shippingAddress_state = :shippingAddress_state, update_at = :update_at WHERE user_id = :user_id';
        ...
        if ($statementt = $pdo->prepare($sqll)) {
            ...
            $statementt->bindValue(':shippingAddress_state', $state);
            $statementt->bindValue(':update_at', $date);
            $statementt->bindValue(':user_id', $id);
